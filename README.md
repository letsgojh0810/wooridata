...
- 이슬기 <br/>
  실 사용 데이터를 가지고 어떻게 개인에 맞춘 소비를 추천해줄 수 있을 지 고민할 수 있는 시간을 가졌다. 평소에 생각만 하던 아이디어를 직접 분석해보고 프로젝트로 도출해낼 수 있어서 뜻깊은 시간이었다. 
  또한, 윈도우 환경이 아닌 Ubuntu 환경에서 ELK를 설치하고 해당 서버를 연결해 사용함으로써 Linux 명령어도 많이 배우고, 가상 메모리인 Swap을 할당하는 방법도 배웠다.